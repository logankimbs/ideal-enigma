...
const createSectionBlock = (text: string, accessory?: any): any => ({
  type: "section",
  text: {
    type: "mrkdwn",
    text: text,
...
const createButton = (text: string, value: string): any => ({
  type: "button",
  text: {
    type: "plain_text",
    text: text,
...
export const getHomeBlocks = () => {
  return [
    ...
    createSectionBlock(
      ...
      createButton("Submit an Insight", "start_donut_channel"),
    ),
    createSectionBlock(
